...
namespace Marmalade\GraphQL\GraphQLPlayground\Tests\Codeception\Helper;
...
final class Acceptance extends \Codeception\Module
{
    public function _beforeSuite($settings = []): void
    {
        ...
        exec((new Facts())->getShopRootPath() . '/bin/oe-console oe:module:activate marmalade/graph-q-l-playground');
    }
}
